...
# USE THE SAME UNITS WITHIN A TRAJECTORY, SO EACH COLOUR METRIC NEEDS TO BE
# ANALYZED SEPARATELY
# CHECK HUTTEGGER AND MITTEROCKER PAPER: INVARIANCE AND MEANINGFULNESS IN PHENOTYPE SPACES 2011
